...
!(function (t, e) {
          ...
          i.borderWidth &&
            ("inner" === i.borderAlign
              ? (e.beginPath(),
                ...
                i.innerRadius > o ? ((t = o / i.innerRadius), e.arc(i.x, i.y, i.innerRadius - o, a + t, n - t, !0)) : e.arc(i.x, i.y, o, a + Math.PI / 2, n - Math.PI / 2),
                e.closePath(),
                e.clip(),
                e.beginPath(),
      ...
      draw: function (t) {
        ...
        e.skip ||
          ((void 0 === t || ut.canvas._isPointInArea(e, t)) &&
            ((i.strokeStyle = e.borderColor || d), (i.lineWidth = It(e.borderWidth, l.elements.point.borderWidth)), (i.fillStyle = e.backgroundColor || d), ut.canvas.drawPoint(i, n, o, r, s, a)));
      },
    }),
  ...
  var Nt = pt.extend({
      draw: function () {
        ...
        (t.fillStyle = e.backgroundColor),
          ...
          (n.w === a.w && n.h === a.h) || (t.save(), t.beginPath(), t.rect(n.x, n.y, n.w, n.h), t.clip(), (t.fillStyle = e.borderColor), t.rect(a.x, a.y, a.w, a.h), t.fill("evenodd"), t.restore());
      },
      height: function () {
        var t = this._view;
        return t.base - t.y;
      ...
      updateBezierControlPoints: function () {
        ...
        if (a.options.elements.line.capBezierPoints)
          for (t = 0, e = l.length; t < e; ++t)
            (i = l[t]._model),
              ee(i, s) &&
                (t > 0 && ee(l[t - 1]._model, s) && ((i.controlPointPreviousX = d(i.controlPointPreviousX, s.left, s.right)), (i.controlPointPreviousY = d(i.controlPointPreviousY, s.top, s.bottom))),
                t < l.length - 1 && ee(l[t + 1]._model, s) && ((i.controlPointNextX = d(i.controlPointNextX, s.left, s.right)), (i.controlPointNextY = d(i.controlPointNextY, s.top, s.bottom))));
      },
      draw: function () {
        var t,
          e = this.chart,
  ...
  var Ze = pt.extend({
      ...
      draw: function () {
        ...
        if (0 !== e.opacity) {
          ...
          this._options.enabled &&
            o &&
            (t.save(), (t.globalAlpha = a), this.drawBackground(n, e, t, i), (n.y += e.yPadding), this.drawTitle(n, e, t), this.drawBody(n, e, t), this.drawFooter(n, e, t), t.restore());
        }
      },
      handleEvent: function (t) {
        ...
        return (
          ...
          (e = !ut.arrayEquals(i._active, i._lastActive)) && ((i._lastActive = i._active), (n.enabled || n.custom) && ((i._eventPosition = { x: t.x, y: t.y }), i.update(!0), i.pivot())),
          e
        );
      },
    }),
      ...
      draw: function (t) {
        ...
        if (e._isVisible()) {
          ...
          if (F) {
            ...
            m ? ((W = L(r, e.left, j) - j / 2), (V = L(r, e.right, q) + q / 2), (E = H = n)) : ((E = L(r, e.top, j) - j / 2), (H = L(r, e.bottom, q) + q / 2), (W = V = n)),
              (s.lineWidth = F),
  ...
  var Ci = fi.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = _i(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min ? ((t.min = Math.pow(10, Math.floor(ut.log10(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(ut.log10(t.max)) + 1))) : ((t.min = 1), (t.max = 10))),
      ...
      getPixelForValue: function (t) {
        ...
        return (
          ...
          t !== n && (0 === n && ((e -= h = wi(s.fontSize, st.global.defaultFontSize)), (n = u)), 0 !== t && (h += (e / (d(a) - d(n))) * (d(t) - d(n))), (i += o * h)),
          i
        );
      },
      getValueForPixel: function (t) {
                ...
                if (
                  (i.display &&
                    ...
                    (function (t, e, i, n) {
                      ...
                      if ((r || s) && l && d) {
                        if ((o.save(), (o.strokeStyle = l), (o.lineWidth = d), o.setLineDash && (o.setLineDash(e.borderDash || []), (o.lineDashOffset = e.borderDashOffset || 0)), o.beginPath(), r))
  ...
  var Ji = fi.extend({
      ...
      update: function () {
        ...
        return (
          e.format && console.warn("options.time.format is deprecated and replaced by options.time.parser."), ut.mergeIf(e.displayFormats, i.formats()), fi.prototype.update.apply(this, arguments)
        );
      },
      getRightValue: function (t) {
      ...
      determineDataLimits: function () {
        ...
        for (t = 0, i = (s.data.datasets || []).length; t < i; ++t)
          if (s.isDatasetVisible(t))
            if (((a = s.data.datasets[t].data), ut.isObject(a[0]))) for (g[t] = [], e = 0, n = a.length; e < n; ++e) (o = Gi(r, a[e])), f.push(o), (g[t][e] = o);
            else {
        ...
        return (
          ...
          (n._table = (function (t, e, i, n) {
            ...
            for (u.push(i), a = 0, o = u.length; a < o; ++a)
              (l = u[a + 1]), (r = u[a - 1]), (s = u[a]), (void 0 !== r && void 0 !== l && Math.round((l + r) / 2) === s) || d.push({ time: s, pos: a / (o - 1) });
            return d;
  ...
  var un = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (n = 0; n < r; ++n)
          (o = null),
            (a = (i = t.getDatasetMeta(n)).dataset) && a._model && a instanceof Wt.Line && (o = { visible: t.isDatasetVisible(n), fill: an(a, n, r), chart: t, el: a }),
            (i.$filler = o),
            l.push(o);
            ...
            (function (t, e, i, n, a, o) {
              ...
              for (t.beginPath(), r = 0, s = f + !!o; r < s; ++r)
                (u = i((d = e[(l = r % f)]._view), l, n)),
                  (h = ln(d)),
                  (c = ln(u)),
                  h && c ? ((v = p.push(d)), (b = m.push(u))) : v && b && (g ? (h && p.push(d), c && m.push(u)) : (dn(t, p, m, v, b), (v = b = 0), (p = []), (m = [])));
  ...
  var gn = pt.extend({
    ...
    _getLegendItemAt: function (t, e) {
      ...
      if (t >= o.left && t <= o.right && e >= o.top && e <= o.bottom)
        for (a = o.legendHitBoxes, i = 0; i < a.length; ++i) if (t >= (n = a[i]).left && t <= n.left + n.width && e >= n.top && e <= n.top + n.height) return o.legendItems[i];
      return null;
    },
    handleEvent: function (t) {
      var e,
      ...
      (e = i._getLegendItemAt(t.x, t.y)),
        "click" === a
          ...
          : (n.onLeave && e !== i._hoveredItem && (i._hoveredItem && n.onLeave.call(i, t.native, i._hoveredItem), (i._hoveredItem = e)), n.onHover && e && n.onHover.call(i, t.native, e));
    },
  });
  function pn(t, e) {
